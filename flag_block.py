...
class FlagBlock(Block):
    ...
    def draw(self):
        ...
        if self.absorb_side == 'TOP':
            ...
            pyxel.line(self.x, self.y + self.height, self.x + self.width - 1, self.y + self.height, accent_color)
        elif self.absorb_side == 'LEFT':
            pyxel.line(self.x, self.y, self.x, self.y + self.height - 1, accent_color)
        elif self.absorb_side == 'RIGHT':
            pyxel.line(self.x + self.width - 1, self.y, self.x + self.width - 1, self.y + self.height - 1, accent_color)
